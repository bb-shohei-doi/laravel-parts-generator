        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div @click.outside="show = false"
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex">
                    <button wire:click="hideCreate:uc:tableModal()" type="button"
                    ...
                    <button wire:click="create:uc:table({{ $id }})" type="button"
                        class="text-white bg-blue-700 hover:bg-blue-600 mx-3 mt-3 w-full inline-flex justify-center rounded-md boarder border-gray-300 shadow-sm px-4 py-2 font-medium">
                        Create
                </div>
            </div>
        </div>
